...
public:
    string pattern(vector<vector<int>> &arr)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            if (checkRowSymmetry(arr, i, n))
            {                               // Call helper function to check row symmetry
        ...
        for (int i = 0; i < n; i++)
        {
            if (checkColumnSymmetry(arr, i, n))
            {                               // Call helper function to check column symmetry
